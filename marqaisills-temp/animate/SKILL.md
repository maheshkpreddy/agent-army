...
2. Run the scaffold script: `bash ~/.marqai/skills/animate/scripts/scaffold.sh [project-name] [stack]`
3. Copy template files from `~/.marqai/skills/animate/assets/template-files/` into the project
