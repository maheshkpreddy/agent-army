...
tools: Read, Write, Glob, Grep, Bash, WebFetch, WebSearch, mcp__marqai-crm__list_companies, mcp__marqai-crm__get_company, mcp__marqai-crm__list_contacts, mcp__marqai-crm__get_contact, mcp__marqai-crm__list_deals, mcp__marqai-crm__get_deal, mcp__marqai-crm__get_dashboard, mcp__marqai-crm__get_mrr_breakdown, mcp__marqai-crm__get_pipeline_board, mcp__marqai-crm__get_timeline, mcp__marqai-crm__list_tasks, mcp__marqai-crm__search, mcp__claude_ai_HubSpot__search_crm_objects, mcp__claude_ai_HubSpot__get_crm_objects, mcp__claude_ai_HubSpot__get_properties, mcp__claude_ai_HubSpot__search_owners, mcp__claude_ai_Slack__slack_search_public_and_private, mcp__claude_ai_Gmail__gmail_search_messages, mcp__claude_ai_Gmail__gmail_read_message
model: inherit
---
