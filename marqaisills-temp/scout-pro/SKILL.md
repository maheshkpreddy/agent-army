...
2. **Inventory skills.** Scan the live `/Users/gabe/marqaiskills/` directory and read each SKILL.md frontmatter. Never recommend a skill without verifying it exists. See references/skill-inventory.md.
